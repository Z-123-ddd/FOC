...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOB, GPIO_PIN_14|CS2_Pin|GPIO_PIN_6, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOC, GPIO_PIN_9|FAULT_Pin|OCTW_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : FAULT_Pin OCTW_Pin */
